      ...
      <CCol xl="6">
        <CCard>
          <CCardHeader>
            ...
            <div className="card-header-actions">
              <a href="https://coreui.github.io/components/collapse/" rel="noreferrer noopener" target="_blank"
        ...
        <CCard>
          <CCardHeader>
            Fade
            <div className="card-header-actions">
              <a href="https://coreui.github.io/components/fade/" rel="noreferrer noopener" target="_blank"
                 className="card-header-action">
                <small className="text-muted">docs</small>
              </a>
            </div>
